...
namespace AssetInventory
{
    public sealed class SemVer : IComparable
    {
                                ...
                                if (match.Success)
                                {
                                    if (int.TryParse(match.Value, out Patch))
                                    {
                                        if (match.Length < components[3].Length)
                                        {
                                            ...
                                            if (PatchQualifier.StartsWith("-")) PatchQualifier = PatchQualifier.Substring(1);
                                        }
                                    }
                                    else
                                    {
        ...
        public static bool operator >(SemVer version1, SemVer version2)
        {
            ...
            {
                if (version1.MinorQualifier == null) return true;
                if (version2.MinorQualifier == null) return false;
        ...
        public static bool operator <(SemVer version1, SemVer version2)
        {
            ...
            if (version1.MinorQualifier != null || version2.MinorQualifier != null)
            {
                if (version1.MinorQualifier == null) return false;
                if (version2.MinorQualifier == null) return true;
